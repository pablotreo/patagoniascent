        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="box">
                      <h2><span>Esquí Valle del Mosquito.</span></h2>
                        <p>
                            A unos 25 kms al norte de El Chalten, se encuentra el arroyo mosquito. Sus nacientes provienen de la Loma del Diablo. En Invierno este Valle ofrece muchas opciones para el eski touring, desde un nivel principiante, hasta para esquiadores mas experimentados.
                        </p>
